...
const SPECTRUM_SUBSCRIPTION_KEY: &'static str = "Audio.additional_outputs.audio_spectrums";
const INFO_SUBSCRIPTION_KEY: &'static str = "Audio.additional_outputs.detection_infos";
            ...
            .show(ui, |plot_ui| {
                ...
                match detection_info {
                    Ok(detection_info) => {
                        ...
                        let line =
                            Line::new(PlotPoints::from_iter(min_frequency_line_points.into_iter()))
                                .color(Color32::RED);
                        plot_ui.line(line)
                    }
                    Err(error) => error!("{}", error),
